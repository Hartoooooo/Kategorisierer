  ...
  return (
    <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
      <div className={`max-w-7xl mx-auto ${parsedRows.length === 0 ? "flex flex-col min-h-[calc(100vh-4rem)] justify-center" : ""}`}>
        {/* Header mit Titel und Dark/Light Mode Toggle in einer Zeile */}
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            ...
            <a
              href="/kategorien"
              className="px-4 py-2 text-sm bg-blue-600 dark:bg-blue-700 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
            >
              Kategorien
            </a>
            <a
              href="/isin-suche"
              className="px-4 py-2 text-sm bg-green-600 dark:bg-green-700 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors"
            >
              ISIN Suche
            </a>
          </div>
